...
<link rel="icon" href="data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 32 32%27%3E%3Cpath fill=%27%23ff5307%27 d=%27M16 2 1 15h4v3l11-9 11 9v-3h4Z%27/%3E%3Crect x=%278%27 y=%2717%27 width=%2716%27 height=%2711%27 fill=%27%23ff5307%27/%3E%3C/svg%3E">
  ...
  <div class="shell">
    ...
    <div class="steps rv">
      <div class="step">
        ...
        <h3>You call</h3>
        <p>Tell us what you are seeing. A stain, a leak, a storm, or just a roof that has been up there a long time.</p>
      </div>
      <div class="step">
        ...
        <h3>We inspect</h3>
        <p>We come out and look at all of it, not just the spot you pointed at. Free, and with no obligation attached.</p>
      </div>
      <div class="step">
        ...
        <h3>You get the honest version</h3>
        <p>Repair or replace, what it costs, and how long it takes. In plain language, in writing.</p>
      </div>
      <div class="step">
        <span class="step__n">Step 04</span>
        ...
        <h3>We build it</h3>
        <p>One crew, start to finish. We clean up after ourselves and we leave the property the way we found it.</p>
      </div>
    </div>
  </div>
</section>
